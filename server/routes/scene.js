...
// controllers
import { uploadImage, removeImage, create, read, uploadVideo, removeVideo, update, updateArray, saveVideo, updateVideo } from '../controllers/scene';
...
router.post(`/scene/overview-array/:sceneId`, requireSignin, isCreator, updateArray)
router.post(`/scene/video-add/:sceneId`, requireSignin, isCreator, saveVideo)
router.post(`/scene/video-update/:sceneId`, requireSignin, isCreator, updateVideo)
