...
// controllers
import { uploadImage, removeImage, create, read, uploadVideo, removeVideo, update, updateArray, updateVideo } from '../controllers/scene';
...
router.post(`/scene/video-add/:sceneId`, requireSignin, isCreator, updateVideo)
